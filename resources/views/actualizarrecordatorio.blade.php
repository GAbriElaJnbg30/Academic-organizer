    ...
    <div class="main-content" id="mainContent">
        <div class="container">
            ...
            <form id="reminderForm" method="POST"
                action="{{ route('recordatorios.update', $recordatorio->id_recordatorio ?? '') }}">
                @csrf
                @method('PUT')
                <div class="form-group">
                    <label for="titulo" class="required">Título</label>
                    <input type="text" id="titulo" name="titulo" value="{{ $recordatorio->titulo ?? '' }}" required
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="fecha" name="fecha"
                        value="{{ isset($recordatorio) ? \Carbon\Carbon::parse($recordatorio->fecha)->format('Y-m-d') : '' }}">
                </div>

                <div class="form-group">
                    <label for="hora">Hora</label>
                    <input type="time" id="hora" name="hora"
                        value="{{ isset($recordatorio) ? \Carbon\Carbon::parse($recordatorio->hora)->format('H:i') : '' }}">
                </div>

                <div class="form-group">
                    <label for="descripcion">Descripción</label>
                    <textarea id="descripcion" name="descripcion"
                        placeholder="Ingrese los detalles del recordatorio">{{ $recordatorio->descripcion ?? '' }}</textarea>
                </div>

                <div class="toggle-container">
                    <span class="toggle-label">Recordatorio activado</span>
                    <label class="toggle">
                        <input type="checkbox" id="recordatorio_activado" name="recordatorio_activado"
                            {{ isset($recordatorio) && $recordatorio->recordatorio_activado ? 'checked' : '' }}>
